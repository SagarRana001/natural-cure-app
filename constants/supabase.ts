...
// export const supabase12 = createClient(supabaseUrl, supabaseAnonKey, {
//     auth: {
//       persistSession: true,        // ✅ keeps user logged in between app launches
//       autoRefreshToken: true,      // ✅ automatically refreshes expired sessions
//       detectSessionInUrl: false,   // ✅ disables redirect URL detection (for Expo apps)
//     },
//   });